...
#SBATCH -J nf_loclat
#SBATCH -o /crex/proj/fume/nobackup/private/jay/squeezmeta/logs/20240301_loclat.log
#SBATCH -e /crex/proj/fume/nobackup/private/jay/squeezmeta/logs/20240301_loclat.err
#SBATCH --mail-user jay.hakansson@slu.se
#SBATCH --mail-type=FAIL,END

mamba activate SqueezeMeta
res_name="loclat_20240221_1M_subsamp"
run_name="loclat_20240301_1M_subsamp"
